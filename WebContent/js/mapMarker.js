...
function addSampleTrip(){
	...
	m1.content.userContent="在上海火车站乘坐去桐乡的列车";                                         
	...
	m2.content.userContent="在桐乡火车站直接坐k282的班车到乌镇汽车站"; 
	...
	m3.content.imgs=[
	                 ...
	                 {url:'http://www.114piaowu.com/upload/newsimages/2013_10/20131009121228_893.jpg',title:'P3'}];
	m3.content.userContent="再转K350才能到西栅。东西栅联票150，可是只限当天游完，一天来不及只能分开买，西栅120，东栅100。早知道东栅的小景点是打洞的，我住东栅景区内就买联票了，呜呜~~~~~~看来下次还是要相信自己的判断。西栅是全封闭的景区，里面的住宿都是由政府统一规划，无论是民宿、客栈还是会所，价格都不便宜，按照房间的条件，从300多到1000多不等，而且预算不高的民宿，提前2周都已经预定完。因为最合理的行程是买联票，第一天先游览东栅，晚上到达西栅，第二天都用来游览比东栅大3倍的西栅。然后从西栅门口，乘夜班18：00~20:00的K282直接到桐乡火车站。且还能省下140元买联票，如此西栅的房价就变成100多了。谁让小磨楚的行踪不定呢？连火车票都是最后几分钟才定好的。"; 
	...
	mG1.content.userContent="在上海火车站乘坐去桐乡的列车"; 
	...
	m4.content.userContent="早上8点多从内环粗发，千辛万苦到达西栅，已经过中午了。景区大门口的摆渡船有点鸡肋，走走也就400~500米的路程，却要花上20~30分钟等船，可是花了这么贵的门票，不做免费船有点可惜了，所以继续等吧。。。。。。好在一进景区就是事先做好功课的“裕生餐馆”。"; 
	...
	m6.content.userContent="三寸金莲馆搜集了旧时民间的各种绣花鞋，展示了裹足的惨痛历史，让我不由的想起了外婆的妈妈，裹了足还走老远的路去看我外公，发现是个文书很好的白面小生，才放心的嫁外婆。李煜这个昏君，活该痛失江山！而楚这时在三寸金莲馆门口排队买油墩子，排了起码有20分钟不止。吃萝卜丝饼的人真多，3块钱一个很大，不过这种油腻的东东兔是不喜欢，小磨楚买多了，只能帮他吃掉1个，他吃2个。楚看三寸金莲馆毫无感觉，还在回味着他的油墩子，无同情心的男人哦~"; 
	...
	m7.content.userContent="景点看个7分，重头戏还在于吃。乌梅青号10元一杯的乌梅茶和青梅茶是鲜酿的很好喝，随心杯还能带走，买了带青梅带走20元。凉茶铺的养生茶和酸梅汁也是10元，送的杯子比乌梅店的稍差，凉茶铺只有一个阿叔在忙，排队等起来的时候，真是没底的，尤其是有人点了鲜榨果汁，我们是第二次路过才买的。可是养生茶为毛是烫的呢？在码头坐了半天才凉到能喝的地步，害我被蚊子叮了好几口。3元一块的桂花年糕很好吃，可惜没有买乌镇烧饼，很大很大一个，排队的人多。本想着第二天去东栅买来吃的，没想到再也没见到过T_T"; 
...
function addOneMark(map, p) {
	...
	marker.addEventListener("click", function() {
		...
		if(marker.content.getGalleryHtmlContent()!=null){
			info2.setContentA(marker.content.getGalleryHtmlContent(),true);
			info2.setContentB(createBasicInfo(marker.content.userContent),false);
			info2.resetLocation("230px","30px");
			info2.show();
			info2.showContentA();
		}else{
			info2.resetLocation("230px","30px");
...
function MarkerContent(){
	...
	this.getHtmlContent=function(){
		return createTitleContentA(this.title,this.address);
	};
	this.getGalleryHtmlContent=function(){
		if(this.imgs!=null){
			return createImgGallery(this.imgs,this.title);
		}else{
			return null;
		}
	};
