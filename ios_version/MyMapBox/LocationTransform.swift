...
@objc public class LocationTransform {
    ...
    class func wgs2gcj(wgsLat: Double, wgsLon: Double) -> [String: Double] {
    ...
    class func gcj2wgs(gcjLat: Double, gcjLon: Double) -> [String: Double] {
    ...
    class func gcj2wgs_exact(gcjLat: Double, gcjLon: Double) -> [String: Double] {
    ...
    class func gcj2bd(gcjLat: Double, gcjLon: Double) -> [String: Double] {
        if isOutOfChina(lat: gcjLat, lon: gcjLon) {
            return [latKey: gcjLat, lonKey: gcjLon]
        }
    ...
    class func bd2gcj(bdLat: Double, bdLon: Double) -> [String: Double] {
    ...
    class func wgs2bd(wgsLat: Double, wgsLon: Double) -> [String: Double] {
        let gcj = wgs2gcj(wgsLat, wgsLon: wgsLon) as [String: Double]
        return gcj2bd(gcj[latKey]!, gcjLon: gcj[lonKey]!)
    }
    
    class func bd2wgs(bdLat: Double, bdLon: Double) -> [String: Double] {
